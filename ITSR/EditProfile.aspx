    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="fullBox white-box">
                <div class="fullBox">
                    <div class="halfBox">
                        <h2 class="margin">Edit Your Profile</h2>
                    </div>
                    <div class="halfBox padding paddingFix">
                        ...
                        <asp:CustomValidator
                            ID="SomethingWrongVal"
                            ForeColor="red"
                            runat="server"
                            Font-Size="Larger"
                            Display="Dynamic"
                            ErrorMessage="Oups! Something went wrong. Try again?">
                        </asp:CustomValidator>
                    </div>
                </div>
                <div class="fullBox">
                        ...
                        <div class="PasswordDiv">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="fullBox">
                                        <div class="halfBox padding paddingFix">
                                            <input id="Button2" type="button" class="Mainbtn" value="Cancel" onclick="hideDiv();" />
                                        </div>
                                        <div class="halfBox padding paddingFix">
                                            <asp:Button ID="BtnNewPassword" runat="server" CssClass="Mainbtn" Text="Save" OnClick="BtnNewPassword_Click" ValidationGroup="SavePassword" />
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
