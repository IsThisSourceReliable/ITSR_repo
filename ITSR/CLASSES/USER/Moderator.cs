...
namespace ITSR.CLASSES.USER
{
    public class Moderator:Member
    {
        ...
        {
            string sql = "Update comment SET removed = @R WHERE idcomment = @CID";
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@R", true);
        ...
        public void RemoveArticle(Articles a)
        {
            string sql = "Update article SET removed = @R WHERE idarticle = @AID";
        ...
        public void BlockUser(BlockBan b)
        {
            ...
            bool exists = m.CheckIfBlockedBefore(b);
